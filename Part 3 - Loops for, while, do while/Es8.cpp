...
Write a program that asks the user for a positive integer and prints the number obtained by reading the given number from right to left. For example, with 17 it prints 71, with 27458 it prints 85472, and so on. */
...
int main()
{
	...
	//- print "Invalid value"
	//- repeat the request for input (and reading) until a positive number is given
